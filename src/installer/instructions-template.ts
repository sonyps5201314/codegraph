...
- **Shell** (always works): use the matching \`codegraph\` subcommand, or \`codegraph explore "<symbol names or question>"\` for exploratory queries; run \`codegraph --help\` to see the available commands.
